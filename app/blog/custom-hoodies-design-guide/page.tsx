...
export const metadata: Metadata = {
  title: "The Ultimate Guide to Designing Custom Hoodies | COUTURE by Ikigai",
  description: "Learn expert tips for creating standout custom hoodies that perfectly represent your organization's identity and elevate your merchandise program.",
  keywords: [
    "custom hoodies design", 
    "custom hoodie guide", 
    "organization hoodie design", 
    "premium custom hoodies", 
    "university custom apparel",
    "custom merch design tips",
    "best custom hoodies",
    "organization merchandise design",
    "high quality custom hoodies",
    "custom apparel design"
  ],
  openGraph: {
    title: "The Ultimate Guide to Designing Custom Hoodies | COUTURE by Ikigai",
    description: "Learn expert tips for creating standout custom hoodies that perfectly represent your organization's identity.",
    url: "https://couturebyikigai.com/blog/custom-hoodies-design-guide",
    siteName: "COUTURE by Ikigai",
    images: [
      {
        url: "https://dcnyckkspvcivlaetfie.supabase.co/storage/v1/object/public/ikigai/lookbook/sinh001485-R1-027-12.jpg",
        width: 1200,
        height: 630,
        alt: "Custom Hoodie Design Guide by COUTURE",
      },
    ],
    locale: "en_US",
    type: "article",
...
export default function BlogPost() {
  const post = getBlogPosts().find((post) => post.id === "custom-hoodies-design-guide");
