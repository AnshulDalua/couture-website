            ...
            >
              <defs>
                <style>
                  ...
                  /* First three letters - explicitly make sure they animate */
                  path:nth-child(1) {
                    animation: drawPath 1.8s ease forwards, fillIn 0.8s 2.6s forwards, fadeOut 0.5s 3.5s forwards;
                  }
                  
                  path:nth-child(2) {
                    animation: drawPath 1.8s 0.2s ease forwards, fillIn 0.8s 2.6s forwards, fadeOut 0.5s 3.5s forwards;
                  }
                  
                  path:nth-child(3) {
                    animation: drawPath 1.8s 0.4s ease forwards, fillIn 0.8s 2.6s forwards, fadeOut 0.5s 3.5s forwards;
                  }
                  
                  /* Remaining letters */
                  path:nth-child(4) {
                    animation: drawPath 1.8s 0.6s ease forwards, fillIn 0.8s 2.6s forwards, fadeOut 0.5s 3.5s forwards;
                  }
                  
                  path:nth-child(5) {
                    animation: drawPath 1.8s 0.8s ease forwards, fillIn 0.8s 2.6s forwards, fadeOut 0.5s 3.5s forwards;
                  }
                  
                  path:nth-child(6) {
                    animation: drawPath 1.8s 1s ease forwards, fillIn 0.8s 2.6s forwards, fadeOut 0.5s 3.5s forwards;
                  }
                  
                  path:nth-child(7) {
                    animation: drawPath 1.8s 1.2s ease forwards, fillIn 0.8s 2.6s forwards, fadeOut 0.5s 3.5s forwards;
                  }
                  
                  /* Exclamation point */
                  path:nth-child(8) {
                    animation: drawPath 1.2s 1.4s ease forwards, fillIn 0.8s 2.6s forwards, fadeOut 0.5s 3.5s forwards;
                  }
                  
                  path:nth-child(9) {
                    animation: drawPath 1.2s 1.6s ease forwards, fillIn 0.8s 2.6s forwards, fadeOut 0.5s 3.5s forwards;
                  }
                  `}
                </style>
              </defs>
