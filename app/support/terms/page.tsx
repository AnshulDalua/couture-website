  ...
  return (
    <div className="px-6 py-8 max-w-3xl mx-auto">
      ...
      <div className="space-y-6 text-xs">
        ...
        <section>
          <h2 className="text-xs uppercase font-medium mb-2">2. ACCOUNT REGISTRATION</h2>
          <p>
        ...
        <section>
          <h2 className="text-xs uppercase font-medium mb-2">3. PRODUCTS AND PURCHASES</h2>
          <p>All products are subject to availability. We reserve the right to discontinue any product at any time.</p>
          <p className="mt-2">
            Prices for our products are subject to change without notice. We reserve the right to correct any errors or
        ...
        <section>
          <h2 className="text-xs uppercase font-medium mb-2">4. INTELLECTUAL PROPERTY</h2>
          <p>
            ...
            thereof) are owned by CoutureByIkigai, its licensors, or other providers of such material and are protected
        ...
        <section>
          <h2 className="text-xs uppercase font-medium mb-2">5. LIMITATION OF LIABILITY</h2>
          <p>
            IN NO EVENT WILL COUTUREBYIKIGAI, ITS AFFILIATES, OR THEIR LICENSORS, SERVICE PROVIDERS, EMPLOYEES, AGENTS,
        ...
        <section>
          <h2 className="text-xs uppercase font-medium mb-2">7. GOVERNING LAW</h2>
          <p>
        ...
        <section>
          <h2 className="text-xs uppercase font-medium mb-2">8. CHANGES TO TERMS</h2>
          <p>
        ...
        <section>
          <h2 className="text-xs uppercase font-medium mb-2">9. CONTACT INFORMATION</h2>
